...
const COLLECTION_META = {
  ...
  'quiet-avatars':       { name: 'Quiet Avatars',       count: 30,  style: 'minimal-abstract', price: 6,  description: '30 subtle abstract avatars for calm, low-distraction placeholders. Perfect for dashboards, CRM tables, comments, and serious mockups.', tags: ['quiet','subtle','minimal','calm','neutral'] },
